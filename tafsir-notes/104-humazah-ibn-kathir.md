# Tafsir Ibn Kathir (Abridged) — Surah 104

Source: quran.com API, tafsir resource 169 ("Ibn Kathir (Abridged)").
Retrieved: 2026-07-24
Surah length: 9 ayahs — all 9 looked up, returning 1 distinct passage(s).

This is the text every `verified: { by: "tafsir Ibn Kathir" }` tag in this
module must be traceable to. Regenerate with:

    node fetch-tafsir.js 104 humazah

---

<!-- passage returned for ayahs 1, 2, 3, 4, 5, 6, 7, 8, 9 -->
...
الَّذِى جَمَعَ مَالاً وَعَدَّدَهُ
...
وَمَآ أَدْرَاكَ مَا الْحُطَمَةُ - نَارُ اللَّهِ الْمُوقَدَةُ - الَّتِى تَطَّلِعُ عَلَى الاٌّفْئِدَةِ
